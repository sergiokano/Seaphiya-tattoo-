...
const PeonyTransition = () => {
    ...
    return (
        <section ref={containerRef} className="bg-paper-white py-48 md:py-64 flex flex-col items-center justify-center relative overflow-hidden border-t border-black/5 min-h-screen">
            ...
            <svg className="absolute -left-32 bottom-0 w-[55%] h-[85%] pointer-events-none opacity-[0.25]" viewBox="0 0 500 700" preserveAspectRatio="xMaxYMax meet" fill="none">
            ...
            <svg className="absolute -right-16 top-0 w-[45%] h-[80%] pointer-events-none opacity-[0.25]" viewBox="0 0 400 600" preserveAspectRatio="xMinYMin meet" fill="none">
                <g stroke="#2D2D2D" strokeLinecap="round" strokeLinejoin="round">
